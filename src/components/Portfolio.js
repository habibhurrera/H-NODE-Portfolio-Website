...
const MetricCard = ({ label, value, sub }) => (
  <div className="p-6 border border-white/10 bg-white/[0.03] backdrop-blur-sm hover:border-cyan-500/40 transition-all duration-500 group">
    <p className="text-xs font-[family-name:var(--font-jetbrains)] text-gray-300 uppercase tracking-widest mb-4 group-hover:text-cyan-400 transition-colors font-semibold">{label}</p>
...
const ProjectCard = ({ id, title, client, tech, problem, solution, result, status, link }) => (
  <div className="group relative border border-white/10 bg-white/[0.02] p-8 hover:bg-cyan-500/[0.04] hover:border-cyan-500/30 transition-all duration-700 h-full flex flex-col will-change-transform">
    <div className="flex justify-between items-start mb-8">
      <div className="flex flex-col text-left">
        ...
        <h4 className="text-2xl font-semibold text-white group-hover:text-cyan-400 transition-colors uppercase tracking-tight">{title}</h4>
      ...
      <div className={`px-3 py-1 border ${status === "DEPLOYED" ? "border-cyan-500/40 text-cyan-400 bg-cyan-500/10" : status === "LIVE" ? "border-green-500/40 text-green-400 bg-green-500/10" : "border-gray-400/30 text-gray-300"} text-[10px] font-[family-name:var(--font-jetbrains)] uppercase tracking-widest shrink-0 font-bold`}>
        {status}
      </div>
    </div>
    ...
    <div className="space-y-4 mb-8 text-left flex-1">
      <div className="flex gap-3">
        <span className="text-xs font-[family-name:var(--font-jetbrains)] text-gray-400 uppercase tracking-widest pt-0.5 shrink-0 w-16 font-bold">Problem</span>
        <p className="text-gray-200 text-sm font-normal leading-relaxed">{problem}</p>
      </div>
      <div className="w-full h-[1px] bg-white/10" />
      <div className="flex gap-3">
        <span className="text-xs font-[family-name:var(--font-jetbrains)] text-cyan-400 uppercase tracking-widest pt-0.5 shrink-0 w-16 font-bold">Solution</span>
        <p className="text-gray-100 text-sm font-normal leading-relaxed">{solution}</p>
      </div>
      <div className="w-full h-[1px] bg-white/10" />
      <div className="flex gap-3">
        <span className="text-xs font-[family-name:var(--font-jetbrains)] text-cyan-400 uppercase tracking-widest pt-0.5 shrink-0 w-16 font-bold">Result</span>
        <p className="text-white text-sm font-semibold leading-relaxed">{result}</p>
      </div>
    </div>

    <div className="flex flex-wrap gap-2 mt-auto pt-6 border-t border-white/10 items-center justify-between">
...
const ServiceCard = ({ title, desc, skills, cta, price }) => (
  <div className="p-10 border border-white/10 bg-white/[0.02] hover:bg-cyan-500/[0.04] hover:border-cyan-500/30 transition-all duration-500 group text-left flex flex-col">
    <div className="flex justify-between items-start mb-4">
      <h4 className="text-2xl font-semibold text-white group-hover:text-cyan-400 transition-colors uppercase tracking-tight">{title}</h4>
      {price && (
        <span className="text-xs font-[family-name:var(--font-jetbrains)] text-cyan-400 border border-cyan-500/30 px-3 py-1 shrink-0 ml-4 font-bold">
          {price}
        </span>
      )}
    </div>
    <p className="text-gray-200 text-base leading-relaxed mb-8 font-normal flex-1">{desc}</p>
        ...
        <section id="about" className="py-40 px-8 max-w-7xl mx-auto relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            <div className="text-left">
              ...
              <div className="space-y-6 text-gray-100 text-lg font-normal leading-relaxed max-w-xl">
                <p>
              ...
              <div className="mt-12 p-6 border-l-2 border-cyan-500/50 bg-cyan-500/[0.04]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-12 lg:pt-0">
              ...
              <div className="sm:col-span-2 p-6 border border-cyan-500/20 bg-cyan-500/[0.05] flex items-center justify-between">
                <div>
        ...
        <section id="contact" className="py-40 px-8 max-w-7xl mx-auto border-t border-white/5">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="text-left">
              ...
              <p className="text-gray-100 text-base font-normal leading-relaxed mb-12 max-w-md">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <a href="mailto:habibhurrera@gmail.com" className="text-xl font-normal hover:text-cyan-400 transition-colors tracking-tight">habibhurrera@gmail.com</a>
                </div>
                <div>
                  ...
                  <a href="https://wa.me/923333934738" target="_blank" rel="noopener noreferrer" className="text-xl font-normal hover:text-green-400 transition-colors tracking-tight">+92 333 3934738</a>
                </div>
                <div>
                  ...
                  <a href="https://linkedin.com/in/muhammad-hurrera-671400250" target="_blank" rel="noopener noreferrer" className="text-xl font-normal hover:text-cyan-400 transition-colors tracking-tight">muhammad-hurrera</a>
                </div>
                <div>
                  <p className="text-xs font-[family-name:var(--font-jetbrains)] text-gray-300 uppercase tracking-widest mb-2 font-bold">GitHub</p>
                  <a href="https://github.com/habibhurrera" target="_blank" rel="noopener noreferrer" className="text-xl font-normal hover:text-cyan-400 transition-colors tracking-tight">habibhurrera</a>
                </div>
              </div>
            </div>
